              ...
              <>
                ...
                <div id="org-report-content">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    {/* Distribution */}
                    <div className="bg-white rounded-lg border border-navy/10 p-6">
                      <h3 className="font-semibold text-navy mb-4">Distribution</h3>
                  ...
                  {orgReport && (
                    <div className="space-y-6">
                      {[
                        ...
                        { title: "Distribution Analysis", key: "distribution_analysis" },
                        { title: "Collective Gaps", key: "collective_gaps" },
                        { title: "Development Priorities", key: "development_priorities" },
                      ].map((section) => (
                        <section
                          key={section.key}
